...
# website: https://github.com/Yangyangii/GAN-Tutorial/blob/master/MNIST/VanillaGAN.ipynb
...
def get_sample_image(G, n_noise):
	...
	results = y_hat.cpu().data.numpy()
	img = np.zeros([280,280])
	for j in range(10):
		img[j*28:(j+1)*28] = np.concatenate([x for x in result[j*10:(j_1)*10]], axis=-1)
	return img
